                        ...
                        <div class="col-6 col-md-4 col-lg-3">
                            <div class="poke-card h-100 text-center p-3 d-flex flex-column align-items-center region-card">
                                <div class="d-flex align-items-center justify-content-center mb-2" style="width:100px;height:100px;background:radial-gradient(circle,#fff5f5 0%,#fff 70%);border-radius:50%;">
                                    <img src="<?php echo e($artwork); ?><?php echo e($region['dex']); ?>.png" alt="<?php echo e($region['icon']); ?>" style="max-width:90px;max-height:90px;object-fit:contain;">
                                </div>
                                <h5 class="fw-bold mb-0 mt-2 section-title"><?php echo e($region['name']); ?></h5>
                                <small class="text-muted"><?php echo e($region['gen']); ?></small>
                                <small class="mt-1 fw-semibold" style="color:#1a1a1a;">Home of <?php echo e($region['icon']); ?></small>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/charleneathena/Herd/w6/photobooth-w6-webdev/resources/views/about.blade.php ENDPATH**/ ?>