        ...
        <div class="container">
            <div class="row align-items-center mb-5">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <img src="<?php echo e(asset('img/about.jpg')); ?>" alt="Our Team" class="img-fluid rounded shadow-lg img-thumbnail">
                </div>
                <div class="col-lg-6">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/claude/photobooth-w6-webdev/resources/views/about.blade.php ENDPATH**/ ?>